...
# param='web=www-jccdex-cn';job="front-code-sync" ;token="115574c30a3084ab6aac18e1b005842a68";curl -X POST "https://whjenkins.jccdex.cn:8443/job/${job}/buildWithParameters?${param}" --user "afd:${token}"